 ...
 * with REST API exposure and revision support.
 *
...
if ( ! class_exists( 'GG_Optimizer_Custom_Meta_Field' ) ) {
	 ...
	 *
	 * Registers custom meta fields for specified post types with configurable
	 * type, sanitization, auth, and REST schema.
	 */
	class GG_Optimizer_Custom_Meta_Field {
